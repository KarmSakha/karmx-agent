...
pub(crate) async fn run(
    ...
    loop {
        ...
        // One pass of this loop is one agent iteration, which is the boundary
        // these hooks bracket. Fired unconditionally but cheap when unsubscribed.
        hook_manager
            .emit(
                crate::hooks::HookEvent::PreAgentIteration,
        ...
        hook_manager
            .emit(
                crate::hooks::HookEvent::PostAgentIteration,
                crate::hooks::HookContext::new(
                    crate::hooks::HookEvent::PostAgentIteration,
                    &session.id,
                )
